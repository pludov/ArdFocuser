...
//int idleCount = 0;             // Nombre d'appel à loop depuis l'arret du moteur
//long speedLevel = 0;
//unsigned long currentSigEnd;     // Heure de fin du signal précedent...
...
//		// FIXME: si on tourne à l'envers, il faut d'abord ralentir avant de repartir !
//		if (!isMoving) {
//			speedLevel = 1;
